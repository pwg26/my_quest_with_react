        ...
        <div className="row justify-content-md-center">
          <div className="col-sm-10 mt-4 mb-1 bg-white rounded">
            ...
            <div className="row align-items-center">
              <div className="col-sm-6 mt-4 mb-2 bg-white rounded">
                <img
                  src="../../images/me.jpg"
                  alt=""
                  className="img-fluid pics-about"
                />
              </div>
            ...
            <div className="row d-flex justify-content-center gap-1">
              <a
                className="text-white col-sm-2 btn btn-primary border border-white backround-tra mb-2"
                href="travel-home.html"
              >
                <svg
              ...
              <a
                className="text-white col-sm-2 btn btn-primary border border-white backround-por mb-2"
                href="portfolio.html"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
